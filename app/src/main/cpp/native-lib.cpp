...
Java_com_qiumz_opencv_FaceDetection_faceDetectionSaveInfo(JNIEnv *env, jobject instance,
                                                              jobject mFaceBitmap);
// bitmap 转成 Mat
...
Java_com_qiumz_opencv_FaceDetection_loadCascade(JNIEnv *env, jobject instance,
                                                    jstring filePath_);
}
